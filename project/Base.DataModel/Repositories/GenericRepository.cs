...
namespace Base.DataModel.Repositories
{
    public class GenericRepository<TEntity> where TEntity : class
    {
        #region Private member variables...

        internal MySQLContext Context;
        ...
        public virtual void Insert(TEntity objEntity)
        {
            try
            {
                if (objEntity == null)
                ...
                this.DbSet.Add(objEntity);
            }
            catch (Exception objException)
            {
                throw new Exception("Erro em Insert()!", objException);
            }
        }
